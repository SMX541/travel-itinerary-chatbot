...
export function ChatProvider({ children }: { children: React.ReactNode }) {
  ...
  const addMessage = (message: ChatMessage) => {
    // If this is a loading message that's replacing another loading message,
    ...
    if (message.id === 'loading') {
      ...
      // If we're adding a new message and there's a loading message,
      // replace the loading message with the new one
      setMessages(prev => {
